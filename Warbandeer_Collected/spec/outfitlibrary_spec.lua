...
describe("outfit library", function()
  ...
  describe("SaveLibraryOutfit", function()
    it("stores the look as its /customset encoding", function()
      assert.is_true(ns.SaveLibraryOutfit("mog", collected.lookWith(ns, 7019)))
      ...
      assert.equal(ns.EncodeOutfit(collected.lookWith(ns, 7019)), entry.look)
    end)

    it("round-trips the look back through LibraryOutfitList", function()
      ns.SaveLibraryOutfit("mog", collected.lookWith(ns, 7019))
    ...
    it("replaces a same-named entry in place rather than appending", function()
      ns.SaveLibraryOutfit("a", collected.lookWith(ns, 1))
      ns.SaveLibraryOutfit("b", collected.lookWith(ns, 2))
      ns.SaveLibraryOutfit("a", collected.lookWith(ns, 99))
    ...
    it("trims surrounding whitespace so ' x ' and 'x' are one entry", function()
      ns.SaveLibraryOutfit("  mog  ", collected.lookWith(ns, 5))
      assert.equal("mog", ns.LibraryOutfits()[1].name)
      ns.SaveLibraryOutfit("mog", collected.lookWith(ns, 6))
    ...
    it("replaces a look whose name differs only in case", function()
      ns.SaveLibraryOutfit("Boylane 3", collected.lookWith(ns, 1))
      ns.SaveLibraryOutfit("boylane 3", collected.lookWith(ns, 2))
      assert.equal(1, #ns.LibraryOutfits())
  ...
  describe("provenance", function()
    ...
    it("overwrites provenance when the look is replaced", function()
      ...
      ns.SaveLibraryOutfit("mog", ns.EmptyOutfitList(), META)
      ns.SaveLibraryOutfit("mog", collected.lookWith(ns, 7019), { char = "Other-Realm", class = "MAGE" })
      local entry = ns.LibraryOutfit("mog")
  ...
  describe("RenameLibraryOutfit", function()
    it("renames in place, keeping position and look", function()
      ns.SaveLibraryOutfit("a", collected.lookWith(ns, 42))
      ns.SaveLibraryOutfit("b", ns.EmptyOutfitList())
  ...
  describe("ImportLibraryOutfit", function()
    it("saves under the set's own name when the library has no such entry", function()
      ...
      local status, name = n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 7019), { armor = "Plate" })
    ...
    it("reports a refused write as failed rather than saved", function()
      local n = collected.load()
      local status = n.ImportLibraryOutfit("   ", collected.lookWith(n, 7019))
    ...
    it("skips a name already holding the identical look", function()
      local n = collected.load()
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 7019))
      local status, name = n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 7019))
    ...
    it("suffixes when the name is taken by a DIFFERENT look", function()
      local n = collected.load()
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 7019))
      local status, name = n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 1234))
    ...
    it("never modifies the entry it collided with", function()
      local n = collected.load()
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 7019), { char = "First-Realm" })
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 1234), { char = "Second-Realm" })
    ...
    it("stays idempotent after a collision has been suffixed", function()
      local n = collected.load()
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 7019))
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 1234))
      local status, name = n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 1234))
      assert.equal("skipped", status)
      assert.equal("TWW 1 (2)", name)
      assert.equal(2, #n.LibraryOutfits())
    ...
    it("walks past occupied suffixes to the first free one", function()
      local n = collected.load()
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 1))
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 2))   -- takes (2)
      n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 3))   -- takes (3)
      local _, name = n.ImportLibraryOutfit("TWW 1", collected.lookWith(n, 4))
