...
-- remembers the last preview from each view, and the **collection window's** Armor|Weapons toggle
-- switches to it (via `RestoreViewPreview`) — what "switch to what I was looking at over here"
-- ought to mean. The room briefly carried its own copy of that toggle (#653); it was removed as a
-- redundant duplicate that also did nothing in outfit mode, so this memory now has exactly one
-- driver.
--
