...
---@field UpdateLookSlots fun(self: DressingRoom, retry: boolean?)  repaint every look-driven slot — both hands and both cosmetics (DressingRoomLookSlots.lua)
---@field _clearLookSlot fun(self: DressingRoom, target: string)  clear a slot's pick — the right-click gesture (DressingRoomLookSlots.lua)
