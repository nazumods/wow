...
reopening. While the dressing room is open, the grid **highlights the row of the set
you're viewing** and moves the highlight as you arrow-navigate (scrolling it into view
if needed), so you never lose your place in the list. The slot columns down each side are tinted by the raid's difficulty,
