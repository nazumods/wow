...
**Deps:** LibNAddOn, LibNUI · **SavedVars:** `WarbandeerCharDB` (v32) · **Commands:** `/characters`, `/wbc` · **API:** `WarbandeerApi`
...
```lua
{ version = 32, numCharacters, lastDailyReset, lastReset, lastSundayReset,
