...
| `data/currency.lua` | Broker `currency`: `RestoredCofferKey`, `gold` (`GetMoney`), `CofferKeyShard`, `HeroDawncrest`, `MythDawncrest` |
...
| `currency` | RestoredCofferKey, gold, CofferKeyShard, HeroDawncrest, MythDawncrest | `PLAYER_MONEY` (gold) | CofferKeyShard: `RESET_WEEKLY` |
