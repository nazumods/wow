...
WarbandeerApi:GetLearnedUnlocks(char?)     → { itemID, label, spell, known }[]?, title
    -- learned class unlocks (Druid "Tome of the Wilds", Hunter "Skill Tames"): the catalog
...
glyphs = {                                             -- v33/v34; broker (data/glyphs.lua)
  ...
  unlocks = { [spell] = true }?,                       -- v34; learned class-unlock spell ids (Druid Tome of the Wilds, Hunter Skill Tames); per-character (not per-spec); nil for a class with none
