...
| [ShadowsOfUI-Inventory](ShadowsOfUI-Inventory/README.md) | LibNAddOn + Warbandeer_Characters | Warbandeer | Adds a "Warband Inventory" block to item tooltips: how many of an item each character holds (bags + bank), plus the warband and guild banks. Hold Shift to hide. |
