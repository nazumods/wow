...
| [ShadowsOfUI-PostOffice](ShadowsOfUI-PostOffice/README.md) | Headless mailbox helper: coin-collected reports, trade blocking, coin auto-subject, modifier-click shortcuts, Forward / copy-mail buttons on open letters, a recipient menu + autocomplete on the To: field, and trade-goods quick-attach buttons. |
