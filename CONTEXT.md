...
| Warbandeer_Characters | `/characters`, `/wbc` | `list`, `delete <name>`, `cleanup`, `refresh`, `refresh items/locks`, `dump`, `dump bank/bankgear/gt/locks/artifact/warband/profgear/wq/delves/dungeons`, `clear delves/dungeons`, `stat`, `missing`, `missing me`, `wmissing` |
