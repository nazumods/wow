-- luacheck: globals BINDING_NAME_WARBANDEER_TOGGLE Warbandeer_ToggleBinding
---@type Warbandeer
local ns = select(2, ...)

-- Keybinding entry point. `Bindings.xml` declares WARBANDEER_TOGGLE under the
-- "Warbandeer" category, so it appears in Esc → Key Bindings for the user to assign
