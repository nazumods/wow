...
- **Great Vault Columns** — a subpanel of checkboxes to show or hide individual Great Vault columns (Raid, Mythic+, World, Key, Raid Lock). The identity columns (character, faction, level) are always shown. Changes apply immediately.
