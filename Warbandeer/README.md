...
- **Consumables** — a subpanel of checkboxes to show or hide each category in the Detail view's Consumables box (flask, combat potion, food, weapon buff, augment rune). Appears only with **ClassCodex** installed (the source of the recommendations). Changes apply immediately.
